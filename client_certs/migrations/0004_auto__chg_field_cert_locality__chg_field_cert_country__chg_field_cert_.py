...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'client_certs_cert', 'locality', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Cert.country'
        db.alter_column(u'client_certs_cert', 'country', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Cert.state'
        db.alter_column(u'client_certs_cert', 'state', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Cert.organizational_unit'
        db.alter_column(u'client_certs_cert', 'organizational_unit', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Cert.common_name'
        db.alter_column(u'client_certs_cert', 'common_name', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Cert.organization'
        db.alter_column(u'client_certs_cert', 'organization', self.gf('django.db.models.fields.CharField')(max_length=32))
    ...
    models = {
        ...
        u'client_certs.cert': {
            ...
            'common_name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            ...
            'organization': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'organizational_unit': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
