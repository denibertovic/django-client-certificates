...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cert.is_valid'
        db.add_column(u'client_certs_cert', 'is_valid',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Cert.valid_until'
        db.add_column(u'client_certs_cert', 'valid_until',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 14, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cert.is_valid'
        db.delete_column(u'client_certs_cert', 'is_valid')

        # Deleting field 'Cert.valid_until'
        db.delete_column(u'client_certs_cert', 'valid_until')
    ...
    models = {
        ...
        u'client_certs.cert': {
            ...
            'url': ('django.db.models.fields.CharField', [], {'default': "'36c9cf04484c4f4faa72c7808adc6a37'", 'unique': 'True', 'max_length': '255'}),
