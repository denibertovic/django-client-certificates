...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Cert', fields ['url']
        db.create_unique(u'client_certs_cert', ['url'])


    def backwards(self, orm):
        # Removing unique constraint on 'Cert', fields ['url']
        db.delete_unique(u'client_certs_cert', ['url'])
    ...
    models = {
        ...
        u'client_certs.cert': {
            ...
            'url': ('django.db.models.fields.CharField', [], {'default': "'17b46c70592441e78ee2911851604394'", 'unique': 'True', 'max_length': '255'}),
