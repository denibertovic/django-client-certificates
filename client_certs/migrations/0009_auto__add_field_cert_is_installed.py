...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cert.is_installed'
        db.add_column(u'client_certs_cert', 'is_installed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cert.is_installed'
        db.delete_column(u'client_certs_cert', 'is_installed')
    ...
    models = {
        ...
        u'client_certs.cert': {
            ...
            'url': ('django.db.models.fields.CharField', [], {'default': "'857e311950cb4387909f2429d710161a'", 'unique': 'True', 'max_length': '255'}),
